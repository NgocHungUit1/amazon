        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            $brand_permission_active = $role_has_permissions_list->where('name', 'brand-index')->first();
            ...
            @if (
                ...
                <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i
                    ...
                    <ul id="product" class="collapse list-unstyled ">
                        ...
                        @endif
                        <?php
                        $index_permission_saler_active = $role_has_permissions_list->where('name', 'products-saler-index')->first();
                        ?>
                        @if ($index_permission_saler_active)
                            <li id="product-list-menu"><a href="{{ route('product.sale.index') }}">Danh sách sản phẩm
                                    người bán</a></li>
                        @endif
                        <?php
                        $add_permission_saler_active = $role_has_permissions_list->where('name', 'products-saler-add')->first();
                        ?>
                        @if ($add_permission_saler_active)
                            <li><a href="{{ route('product.saler') }}">Sản phầm người bán</a></li>
                        @endif
