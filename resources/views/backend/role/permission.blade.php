						    ...
						    <table class="table table-bordered permission-table">
                                ...
                                <tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("products-saler-index", $all_permission))
								                <input type="checkbox" value="1" id="products-saler-index" name="products-saler-index" checked />
								                @else
								                <input type="checkbox" value="1" id="products-saler-index" name="products-saler-index" />
								                @endif
								                <label for="products-saler-index"></label>
							            	</div>
						            	</div>
						            </td>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("products-saler-add", $all_permission))
								               	<input type="checkbox" value="1" id="products-saler-add" name="products-saler-add" checked>
								                @else
								                <input type="checkbox" value="1" id="products-saler-add" name="products-saler-add">
								                @endif
								                <label for="products-saler-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("products-saler-edit", $all_permission))
								                <input type="checkbox" value="1" id="products-saler-edit" name="products-saler-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="products-saler-edit" name="products-saler-edit" />
								                @endif
								                <label for="products-saler-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("products-saler-delete", $all_permission))
								                <input type="checkbox" value="1" id="products-saler-delete" name="products-saler-delete" checked />
								                @else
								                <input type="checkbox" value="1" id="products-saler-delete" name="products-saler-delete" />
								                @endif
								                <label for="products-saler-delete"></label>
							                </div>
							            </div>
						            </td>
						        </tr>
                                ...
                                <tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("brand-index", $all_permission))
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                @else
								                <input type="checkbox" value="1" id="brandr-edit" name="brand-edit" />
								                @endif
