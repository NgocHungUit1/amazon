...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        Route::post('products/product-data', 'productData')->name('products.product-data');
...
// routes/web.php
  Route::post('/sales/add-product', [SaleController::class, 'addProductToStore'])->name('sales.addProduct');
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::get('product-saler', 'productSaler')->name('product.saler');
        Route::get('product-saler/list', 'indexSaler')->name('product.sale.index');
