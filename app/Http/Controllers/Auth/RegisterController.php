...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        $storeData = [
            'name' => $data['company_name'],// Tên cửa hàng được cung cấp từ mảng dữ liệu
            'address' => $data['company_name'],  // Địa chỉ cửa hàng (có thể rỗng)
        ];


        $store = Store::create($storeData);

        // Liên kết người dùng với cửa hàng mới tạo
